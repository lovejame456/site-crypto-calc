(function () {
  var translations = {
    en: {
      ...
      metricWinTrades: 'Win Trades',
      metricSubWinLoss: 'W / L Split',
      metricAtrStops: 'ATR Stops',
      metricSubAtrStops: 'Stop-loss triggers',
      tradeLogTitle: '📡 REAL-TIME LIQUIDATION LOGS',
      tradeLogEmpty: 'No trades yet — adjust parameters to generate signals',

      configDataSource: 'Data Source',
      configToken: 'Token',
      configInterval: 'Interval',
      intervalMock: '365 days simulated',
      intervalMockOnly: 'LIVE mode only',
      configStrategy: 'Strategy',
      configCustomToken: 'Custom',
      strategyTripleDesc: 'BOLL + MACD + ATR triple factor',
      strategyMacrossDesc: 'Golden/Death cross with trailing ATR stop',
      ...
      btnConfigCode: '🔑 Config Code',
      configModalTitle: 'Import / Export Config',
      configExportLabel: 'Your Config Code',
      configImportLabel: 'Paste Config Code',
      btnCopy: 'Copy',
      btnLoad: 'Load',
    ...
    zh: {
      ...
      metricWinTrades: '盈利交易',
      metricSubWinLoss: '胜 / 负分布',
      metricAtrStops: 'ATR止损',
      metricSubAtrStops: '止损触发次数',
      tradeLogTitle: '📡 实时交易日志',
      tradeLogEmpty: '暂无交易 — 调整参数以生成信号',

      configDataSource: '数据源',
      configToken: '代币',
      configInterval: '周期',
      intervalMock: '模拟 365 天',
      intervalMockOnly: '仅 LIVE 模式',
      configStrategy: '策略',
      configCustomToken: '自选',
      strategyTripleDesc: '布林 + MACD + ATR 三因子策略',
      strategyMacrossDesc: '均线金叉/死叉 + ATR 追踪止损',
      strategyRsirevDesc: 'RSI 超卖反弹 + 超买卖出',
      ...
      btnCopyLink: '📋 复制链接',
      btnConfigCode: '🔑 配置码',
      configModalTitle: '导入 / 导出配置',
      configExportLabel: '你的配置码',
      configImportLabel: '粘贴配置码',
      btnCopy: '复制',
      btnLoad: '加载',
      btnSaveLoading: '同步中...',
